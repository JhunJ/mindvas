...
export class Navigation {
	...
	/**
	 * Register Ctrl+click handler for zoom-to-branch (desktop).
	 * Touch devices: use canvas node menu → "Zoom to branch" (no long-press zoom —
	 * it conflicted with press-and-drag to move cards on tablet).
	 */
